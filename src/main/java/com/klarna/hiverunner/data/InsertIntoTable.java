...
public final class InsertIntoTable {
     ...
     */
    public static InsertIntoTable newInstance(String databaseName, String tableName, HiveConf conf, HiveServerContainer hiveServerContainer) {
        TableDataBuilder builder = new TableDataBuilder(getHCatTable(databaseName, tableName, conf));
        TableDataInserter inserter = new TableDataInserter(databaseName, tableName, conf, hiveServerContainer);
