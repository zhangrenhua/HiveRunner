...
import com.klarna.hiverunner.builder.HiveShellBase;
...
public class TableDataInserterTest {
    ...
    public void insertsRowsIntoExistingTable() {
        ...
        TableDataInserter inserter = new TableDataInserter(TEST_DB, TEST_TABLE, hiveShell.getHiveConf(), ((HiveShellBase) hiveShell).getHiveServerContainer());
